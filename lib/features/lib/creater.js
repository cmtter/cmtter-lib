...
var execAsync = pify__default['default'](child_process.exec);
...
function _create() {
  _create = _asyncToGenerator__default['default']( /*#__PURE__*/_regeneratorRuntime__default['default'].mark(function _callee2(_ref) {
    var _yield$getUserInput, name, projectPath, fl1, fl2, allFiles, installLog;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 16:
            ...
            signale.info('安装依赖......');
            _context2.next = 22;
            return execAsync("cd ".concat(projectPath, " && yarn install"));

          case 22:
            installLog = _context2.sent;
