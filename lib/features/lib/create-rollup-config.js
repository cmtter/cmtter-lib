    ...
    return {
      ...
      external: function external(id) {
        ...
        if (useEnvs.rollupExternal && useEnvs.rollupExternal instanceof Function) {
          var r = useEnvs.rollupExternal(format, input, id);
      ...
      plugins: [].concat(_toConsumableArray__default['default'](options.args.autoinstall ? [autoInstall__default['default']()] : []), [commonjs__default['default'](), babel__default['default']({
        presets: [
        /**
